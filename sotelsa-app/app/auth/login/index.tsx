...
const LoginScreen = () => {
  ...
  return (
    <KeyboardAvoidingView className="flex-1 bg-[#0A0C10] justify-center px-6">
        ...
        >
          ...
          <View className="mb-6">
            <View className="flex-row justify-between mb-2">
              ...
              <Pressable>
                {/* <Text className="text-primary text-xs font-bold text-[#4F46E5]">
                  Recovery?
                </Text> */}
              </Pressable>
            </View>
          ...
          {/* Button */}
          <Pressable className="mt-4 p-2 flex-1 flex-row justify-center items-center bg-[#06b6d4] rounded-lg h-12 active:scale-95">
